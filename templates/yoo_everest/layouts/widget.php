...
else if (in_array($widget->position, array('headerbar', 'toolbar-r' ,'toolbar-l', 'toolbar-c', 'footer', 'offcanvas'))) {
    $panel = 'uk-panel';
}
...
// Set title
if (in_array($widget->position, array('headerbar', 'toolbar-r' ,'toolbar-l', 'toolbar-c', 'footer'))) {
    $title = '';
...
if ($widget->menu) {
    ...
    } else if (in_array($widget->position, array('toolbar-l', 'toolbar-r', 'toolbar-c', 'footer'))) {
        $renderer = 'subnav';
